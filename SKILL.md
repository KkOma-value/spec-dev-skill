...
读取 `~/.claude/skills/spec-dev/agents/researcher.md` 获取详细指令。

核心动作：
- **引擎 A（本地代码分析）**：读取项目依赖文件、扫描已有接口和 Service/DAO 层、分析上下游调用关系、识别可复用方法和影响范围
- **引擎 B（联网调研）**：WebSearch 搜索技术方案和最佳实践、查阅框架官方文档、搜索类似需求实现参考
...
读取 `~/.claude/skills/spec-dev/agents/prd-writer.md` 获取详细指令。
读取 `~/.claude/skills/spec-dev/references/prd-template.md` 获取模板。
...
读取 `~/.claude/skills/spec-dev/agents/tech-writer.md` 获取详细指令。
读取 `~/.claude/skills/spec-dev/references/tech-template.md` 获取模板。
...
读取 `~/.claude/skills/spec-dev/agents/spec-generator.md` 获取详细指令。
读取 `~/.claude/skills/spec-dev/references/spec-template.md` 获取模板。
...
读取 `~/.claude/skills/spec-dev/references/archive-template.md` 获取模板。
